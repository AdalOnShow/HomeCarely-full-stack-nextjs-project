            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-white/5 border-white/20 text-white focus:border-blue-500 transition-colors duration-300"
                  value={formData.nid}
                  onChange={(e) =>
                    setFormData((p) => ({ ...p, nid: e.target.value }))
                  }
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 bg-white/5 border-white/20 text-white focus:border-blue-500 transition-colors duration-300"
                      ...
                      >
                        ...
                        <span
                          className={`transition-colors duration-300 ${
                            h.valid ? "text-green-400" : "text-gray-500"
                          }`}
                        >
                          {h.text}
                        </span>
