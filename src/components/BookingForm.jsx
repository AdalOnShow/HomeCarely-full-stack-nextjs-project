...
export default function BookingForm({ serviceId }) {
  ...
  const canProceed = () => {
    if (currentStep === 1)
      return bookingData.duration && bookingData.durationType;
    if (currentStep === 2)
      return (
        bookingData.division &&
    ...
    <div className="pt-24 pb-16">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-10">
          <div
            className={`inline-flex items-center justify-center w-16 h-16 rounded-xl bg-linear-to-r ${service.gradient} mb-4`}
          >
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={step.number} className="flex items-center">
                ...
                <span
                  className={`ml-2 text-sm hidden sm:block transition-colors duration-300 ${
                    isActive ? "text-white" : "text-gray-400"
                  }`}
                >
                  {step.title}
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setBookingData((p) => ({ ...p, durationType: v }))
                      }
                    >
                  ...
                  <div>
                    <label className="block text-sm text-gray-300 mb-2">
                      Number of {bookingData.durationType || "hours/days"}
                    </label>
                    <Input
                      type="number"
                      min="1"
                  ...
                  <div className="flex justify-between text-gray-300">
                    ...
                    <span>
                      ...
                      {bookingData.durationType === "days"
                        ? service.dailyRate
                        : service.hourlyRate}
                      /{bookingData.durationType === "days" ? "day" : "hr"}
                    </span>
                  </div>
                  <div className="flex justify-between text-gray-300">
                    <span>Duration</span>
