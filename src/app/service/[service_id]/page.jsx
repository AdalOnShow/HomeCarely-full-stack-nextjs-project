...
const serviceData = {
  "baby-care": {
    ...
    shortDescription:
      "Professional, loving care for your little ones with certified pediatric specialists.",
    fullDescription:
      "Our baby care service provides comprehensive support for infants and toddlers, ensuring their safety, development, and happiness while giving parents peace of mind.",
    icon: Baby,
  ...
  "elderly-care": {
    ...
    shortDescription:
      "Compassionate senior care that preserves dignity and promotes independence.",
    fullDescription:
      "Our elderly care service helps seniors maintain independence while receiving needed support.",
    icon: UserCheck,
  ...
  "sick-care": {
    ...
    shortDescription:
      "Expert medical care and recovery assistance in the comfort of your home.",
    fullDescription:
      "Our sick care service provides professional medical support for individuals recovering from illness, surgery, or managing chronic conditions.",
    icon: Stethoscope,
      ...
      <section className="relative pt-24 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div
              className={`inline-flex items-center justify-center w-24 h-24 rounded-2xl bg-linear-to-r ${service.gradient} mb-8 shadow-2xl`}
            >
            ...
            <Link href={`/booking/${service_id}`}>
              <Button
                size="lg"
                className="btn-premium text-white font-semibold px-10 text-lg hover:scale-105 transition-transform duration-300"
              >
            ...
            <div className="glass-card border-white/10 rounded-2xl p-8">
              ...
              <div className="mt-8">
                <Link href={`/booking/${service_id}`}>
                  <Button
                    size="lg"
                    className="btn-premium text-white font-semibold px-10 hover:scale-105 transition-transform duration-300"
                  >
