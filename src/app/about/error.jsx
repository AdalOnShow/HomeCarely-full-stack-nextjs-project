    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="text-center relative z-10 max-w-lg">
        ...
        <h1 className="text-4xl font-bold mb-4">
          <span className="bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent">Page Error</span>
        </h1>
        <p className="text-gray-400 mb-8 text-lg">We couldn't load this page. Please try again.</p>
